(defun color-theme-merbivore ()
  ...
  (color-theme-install
   ...
   (font-lock-builtin-face ((t (:foreground "#ADADAD"))))
   ...
   (font-lock-function-name-face ((t (:foreground "#BFBFBF"))))
   (font-lock-keyword-face ((t (:foreground "#BFBFBF"))))
   ...
   (font-lock-type-face ((t (:foreground "#BFBFBF"))))
